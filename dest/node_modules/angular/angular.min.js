...
!function(N, W, u) {
    ...
    function G(b) {
        return function() {
            var c, a = arguments[0];
            for (c = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.4.5/" + (b ? b + "/" : "") + a, 
    ...
    function Da(b) {
        ...
        return b.nodeType === pa && a ? !0 : H(b) || K(b) || 0 === a || "number" == typeof a && a > 0 && a - 1 in b;
    }
    function n(b, a, c) {
        var d, e;
        ...
        } else if (b.forEach && b.forEach !== n) b.forEach(a, c, b); else if (lc(b)) for (d in b) a.call(c, b[d], d, b); else if ("function" == typeof b.hasOwnProperty) for (d in b) b.hasOwnProperty(d) && a.call(c, b[d], d, b); else for (d in b) Na.call(b, d) && a.call(c, b[d], d, b);
        return b;
    }
    function mc(b, a, c) {
    ...
    function Mb(b, a, c) {
        for (var d = b.$$hashKey, e = 0, f = a.length; f > e; ++e) {
            var g = a[e];
            if (D(g) || B(g)) for (var h = Object.keys(g), l = 0, k = h.length; k > l; l++) {
                var m = h[l], q = g[m];
    ...
    function fa(b, a, c, d) {
        ...
        if (a) {
            if (b === a) throw Ea("cpi");
            c = c || [], d = d || [], D(b) && (c.push(b), d.push(a));
            var e;
            if (K(b)) for (e = a.length = 0; e < b.length; e++) a.push(fa(b[e], null, c, d)); else {
                var f = a.$$hashKey;
                if (K(a) ? a.length = 0 : n(a, function(b, c) {
                    delete a[c];
                }), lc(b)) for (e in b) a[e] = fa(b[e], null, c, d); else if (b && "function" == typeof b.hasOwnProperty) for (e in b) b.hasOwnProperty(e) && (a[e] = fa(b[e], null, c, d)); else for (e in b) Na.call(b, e) && (a[e] = fa(b[e], null, c, d));
                oc(a, f);
            }
        } else if (a = b, D(b)) {
            if (c && -1 !== (f = c.indexOf(b))) return d[f];
            if (K(b)) return fa(b, [], c, d);
            if (sc.test(sa.call(b))) a = new b.constructor(b); else if (ca(b)) a = new Date(b.getTime()); else {
                if (!Oa(b)) return e = Object.create(qc(b)), fa(b, e, c, d);
    ...
    function ia(b, a) {
        ...
        } else if (D(b)) for (c in a = a || {}, b) ("$" !== c.charAt(0) || "$" !== c.charAt(1)) && (a[c] = b[c]);
        return a || b;
    }
    function ka(b, a) {
        if (b === a) return !0;
    ...
    function Xd(b, a) {
        var c = a;
        return "string" == typeof b && "$" === b.charAt(0) && "$" === b.charAt(1) ? c = u : Ya(a) ? c = "$WINDOW" : a && W === a ? c = "$DOCUMENT" : $a(a) && (c = "$SCOPE"), 
        c;
    }
    function db(b, a) {
        return "undefined" == typeof b ? u : (X(a) || (a = a ? 2 : null), JSON.stringify(b, Xd, a));
    }
    function uc(b) {
    ...
    function xc(b) {
        ...
        return n((b || "").split("&"), function(b) {
            ...
            f = b.substring(d + 1)), e = wc(e), x(e) && (f = x(f) ? wc(f) : !0, Na.call(a, e) ? K(a[e]) ? a[e].push(f) : a[e] = [ a[e], f ] : a[e] = f));
        }), a;
    }
    function Pb(b) {
        var a = [];
    ...
    function Yd(b, a) {
        var c, d, e = Qa.length;
        for (d = 0; e > d; ++d) if (c = Qa[d] + a, H(c = b.getAttribute(c))) return c;
        return null;
    }
    function Zd(b, a) {
        var c, d, e = {};
    ...
    function yc(b, a, c) {
        ...
        return N && e.test(N.name) && (c.debugInfoEnabled = !0, N.name = N.name.replace(e, "")), 
        N && !f.test(N.name) ? d() : (N.name = N.name.replace(f, ""), aa.resumeBootstrap = function(b) {
            return n(b, function(b) {
                a.push(b);
            }), d();
        }, void (B(aa.resumeDeferredBootstrap) && aa.resumeDeferredBootstrap()));
    }
    function $d() {
        N.name = "NG_ENABLE_DEBUG_INFO!" + N.name, N.location.reload();
    }
    function ae(b) {
        if (b = aa.element(b).injector(), !b) throw Ea("test");
    ...
    function ce() {
        ...
        if (!Ac) {
            var a = ob();
            la = N.jQuery, x(a) && (la = null === a ? u : N[a]), la && la.fn.on ? (z = la, Q(la.fn, {
                scope: Ra.scope,
                ...
                var d;
                if (Qb) Qb = !1; else for (var f, e = 0; null != (f = a[e]); e++) (d = la._data(f, "events")) && d.$destroy && la(f).triggerHandler("$destroy");
                b(a);
            }) : z = R, aa.element = z, Ac = !0;
        }
    }
    function pb(b, a, c) {
    ...
    function Sa(b, a, c) {
        return c && K(b) && (b = b[b.length - 1]), pb(B(b), a, "not a function, got " + (b && "object" == typeof b ? b.constructor.name || "Object" : typeof b)), 
        b;
    }
    function Ta(b, a) {
    ...
    function de(b) {
        ...
        return b = a(b, "angular", Object), b.$$minErr = b.$$minErr || G, a(b, "module", function() {
            var b = {};
            return function(f, g, h) {
                ...
                return g && b.hasOwnProperty(f) && (b[f] = null), a(b, f, function() {
                    ...
                    function b(a, c) {
                        return function(b, e) {
                            return e && B(e) && (e.$$moduleName = f), d.push([ a, c, arguments ]), E;
                        };
                    }
    ...
    function ee(b) {
        ...
        }), (Rb = de(N))("ng", [ "ngLocale" ], [ "$provide", function(a) {
            a.provider({
                $$sanitizeUri: ge
                ...
                ngInclude: Pe
            }).directive(sb).directive(Ic), a.provider({
                $anchorScroll: Qe,
                $animate: Re,
                $animateCss: Se,
                $$animateQueue: Te,
    ...
    function R(b) {
        ...
        var a;
        if (H(b) && (b = T(b), a = !0), !(this instanceof R)) {
    ...
    function ub(b, a) {
        ...
        Nc(b)), delete gb[c], b.ng339 = u));
    }
    function vb(b, a) {
        var c = b.ng339, c = c && gb[c];
        return a && !c && (b.ng339 = c = ++Ef, c = gb[c] = {
            events: {},
            data: {},
            handle: u
        }), c;
    ...
    function zb(b, a, c) {
        for (9 == b.nodeType && (b = b.documentElement), a = K(a) ? a : [ a ]; b; ) {
            for (var d = 0, e = a.length; e > d; d++) if ((c = z.data(b, a[d])) !== u) return c;
    ...
    function Ff(b, a) {
        a = a || N, "complete" === a.document.readyState ? a.setTimeout(b) : z(a).on("load", b);
    }
    function Qc(b, a) {
    ...
    function eb(b, a) {
        function c(a) {
            return function(b, c) {
                return D(b) ? void n(b, nc(a)) : a(b, c);
            };
        }
        function d(a, b) {
            if (Ta(a, "service"), (B(b) || K(b)) && (b = s.instantiate(b)), !b.$get) throw Ha("pget", a);
        ...
        function g(a) {
            ...
            return n(a, function(a) {
                ...
                if (!m.get(a)) {
                    m.put(a, !0);
                    try {
                        H(a) ? (c = Rb(a), b = b.concat(g(c.requires)).concat(c._runBlocks), d(c._invokeQueue), 
        ...
        function h(b, c) {
            ...
            function e(b, c, f, g) {
                ...
                var l, s, m, h = [], k = eb.$$annotate(b, a, g);
                for (s = 0, l = k.length; l > s; s++) {
                    if (m = k[s], "string" != typeof m) throw Ha("itkn", m);
                    h.push(f && f.hasOwnProperty(m) ? f[m] : d(m, g));
                }
                return K(b) && (b = b[l]), b.apply(c, h);
            }
            return {
                invoke: e,
                instantiate: function(a, b, c) {
                    var d = Object.create((K(a) ? a[a.length - 1] : a).prototype || null);
                    return a = e(a, d, b, c), D(a) || B(a) ? a : d;
                },
                get: d,
        ...
        this.disableAutoScrolling = function() {
            ...
            function f(b) {
                if (b) {
                    b.scrollIntoView();
                    var c;
                    c = g.yOffset, B(c) ? c = c() : rc(c) ? (c = c[0], c = "fixed" !== a.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : X(c) || (c = 0), 
    ...
    function hb(b, a) {
        return b || a ? b ? a ? (K(b) && (b = b.join(" ")), K(a) && (a = a.join(" ")), b + " " + a) : b : a : "";
    }
    function Jf(b) {
        H(b) && (b = b.split(" "));
        var a = ga();
    ...
    function Kf(b, a, c, d) {
        ...
        function h() {
            (A !== l.url() || p !== w) && (A = l.url(), p = w, n(O, function(a) {
                a(l.url(), w);
            }));
        }
        ...
        g(), p = w, l.url = function(a, c, e) {
            if (y(e) && (e = null), k !== b.location && (k = b.location), m !== b.history && (m = b.history), 
            a) {
                var f = p === e;
                if (A === a && (!d.history || f)) return l;
                var h = A && Ja(A) === Ja(a);
                return A = a, p = e, !d.history || h && f ? ((!h || M) && (M = a), c ? k.replace(a) : h ? (c = k, 
                e = a.indexOf("#"), a = -1 === e ? "" : a.substr(e), c.hash = a) : k.href = a) : (m[c ? "replaceState" : "pushState"](e, "", a), 
                g(), p = w), l;
            }
        ...
        l.onUrlChange = function(a) {
            return J || (d.history && z(b).on("popstate", f), z(b).on("hashchange", f), J = !0), 
            O.push(a), a;
    ...
    function We() {
        this.$get = function() {
            function b(b, d) {
                ...
                var g = 0, h = Q({}, d, {
                    id: b
                }), l = {}, k = d && d.capacity || Number.MAX_VALUE, m = {}, q = null, s = null;
                return a[b] = {
                    put: function(a, b) {
                        if (!y(b)) {
                    ...
                    remove: function(a) {
                        if (k < Number.MAX_VALUE) {
                            var b = m[a];
                            if (!b) return;
                            b == q && (q = b.p), b == s && (s = b.n), f(b.n, b.p), delete m[a];
                        }
                        delete l[a], g--;
                    },
                    removeAll: function() {
    ...
    function Cc(b, a) {
        ...
        this.directive = function s(a, f) {
            return Ta(a, "directive"), H(a) ? (d(a), pb(f, "directiveFactory"), e.hasOwnProperty(a) || (e[a] = [], 
            b.factory(a + "Directive", [ "$injector", "$exceptionHandler", function(b, d) {
                var f = [];
                return n(e[a], function(e, g) {
                    try {
                        var h = b.invoke(e);
                        B(h) ? h = {
                            compile: qa(h)
                        ...
                        if (D(k.scope) && (!0 === k.bindToController ? (m.bindToController = c(k.scope, s, !0), 
                        m.isolateScope = {}) : m.isolateScope = c(k.scope, s, !1)), D(k.bindToController) && (m.bindToController = c(k.bindToController, s, !0)), 
                        D(m.bindToController)) {
                        ...
                        var r = l.$$bindings = m;
                        D(r.isolateScope) && (h.$$isolateBindings = r.isolateScope), h.$$moduleName = e.$$moduleName, 
                        f.push(h);
                    } catch (u) {
                        d(u);
                    }
                }), f;
            } ])), e[a].push(f)) : n(a, nc(s)), this;
        ...
        this.debugInfoEnabled = function(a) {
            ...
            function V(a, b, c, d, e) {
                a instanceof z || (a = z(a)), n(a, function(b, c) {
                ...
                return function(b, c, d) {
                    ...
                    return V.$$addScopeInfo(d, b), c && c(d, b), f && f(b, d, d, e), d;
                };
            }
            function S(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    var f, k, l, m, s, t, O;
                    if (p) for (O = Array(c.length), m = 0; m < h.length; m += 3) f = h[m], O[f] = c[f]; else O = c;
                    for (m = 0, s = h.length; s > m; ) k = O[h[m++]], c = h[m++], f = h[m++], c ? (c.scope ? (l = a.$new(), 
                    V.$$addScopeInfo(z(k), l), (t = c.$$destroyBindings) && (c.$$destroyBindings = null, 
                    l.$on("$destroyed", t))) : l = a, t = c.transcludeOnThisElement ? P(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? P(a, b) : null, 
                    c(f, l, k, d, t, c)) : f && f(a, k.childNodes, u, e);
                }
                for (var k, l, m, s, p, h = [], t = 0; t < a.length; t++) k = new aa(), l = ha(a[t], [], k, 0 === t ? d : u, e), 
                ...
                (f || k) && (h.push(t, f, k), s = !0, p = p || f), f = null;
                return s ? g : null;
            }
            function P(a, b, c) {
            ...
            function ha(a, b, c, d, e) {
                ...
                switch (a.nodeType) {
                  case pa:
                    x(b, va(ta(a)), "E", d, e);
                    for (var l, m, s, p = a.attributes, t = 0, O = p && p.length; O > t; t++) {
                        var L = !1, J = !1;
                        l = p[t], k = l.name, m = T(l.value), l = va(k), (s = ia.test(l)) && (k = k.replace(Xc, "").substr(8).replace(/_(.)/g, function(a, b) {
                            return b.toUpperCase();
                        }));
                        var S = l.replace(/(Start|End)$/, "");
                        G(S) && l === S + "Start" && (L = k, J = k.substr(0, k.length - 5) + "end", k = k.substr(0, k.length - 6)), 
                        l = va(k.toLowerCase()), h[l] = k, (s || !c.hasOwnProperty(l)) && (c[l] = m, Qc(a, l) && (c[l] = !0)), 
                        X(a, b, m, l, s), x(b, l, "A", d, e, L, J);
                    }
                    if (a = a.className, D(a) && (a = a.animVal), H(a) && "" !== a) for (;k = g.exec(a); ) l = va(k[2]), 
                    x(b, l, "C", d, e) && (c[l] = T(k[3])), a = a.substr(k.index + k[0].length);
                    break;
                  ...
                  case 8:
                    try {
                        (k = f.exec(a.nodeValue)) && (l = va(k[1]), x(b, l, "M", d, e) && (c[l] = T(k[2])));
                    } catch (E) {}
                }
                return b.sort(za), b;
            }
            ...
            function Wc(a, b, c) {
                return function(d, e, f, g, h) {
                    return e = ya(e[0], b, c), a(d, e, f, g, h);
                };
            }
            function C(a, b, d, e, f, g, h, k, m) {
                function s(a, b, c, d) {
                    a && (c && (a = Wc(a, c, d)), a.require = C.require, a.directiveName = x, (P === C || C.$$isolateScope) && (a = Z(a, {
                        isolateScope: !0
                    })), h.push(a)), b && (c && (b = Wc(b, c, d)), b.require = C.require, b.directiveName = x, 
                    (P === C || C.$$isolateScope) && (b = Z(b, {
                        isolateScope: !0
                    })), k.push(b));
                }
                function t(a, b, c, d) {
                    ...
                    } else if (K(b)) for (e = [], g = 0, f = b.length; f > g; g++) e[g] = t(a, b[g], c, d);
                    return e || null;
                }
                function O(a, b, c, d, e, f) {
                    ...
                    for (h in d) {
                        ...
                        "@" == m && (m = b[k.name]), l = p(m, l, !0, k.controllerAs), g[k.name] = l, r || a.data("$" + k.name + "Controller", l.instance);
                    }
                    return g;
                }
                function L(a, c, e, f, g, l) {
                    function m(a, b, c) {
                        var d;
                        return $a(a) || (c = b, b = a, a = u), r && (d = A), c || (c = r ? ja.parent() : ja), 
                        g(a, b, d, c, ya);
                    }
                    var s, p, J, E, A, ha, ja;
                    if (b === e ? (f = d, ja = d.$$element) : (ja = z(e), f = new aa(ja, d)), P && (E = c.$new(!0)), 
                    g && (ha = m, ha.$$boundTransclude = g), w && (A = O(ja, f, ha, w, E, c)), P && (V.$$addScopeInfo(ja, E, !0, !(F && (F === P || F === P.$$originalDirective))), 
                    V.$$addScopeClass(ja, !0), E.$$isolateBindings = P.$$isolateBindings, Y(c, f, E, E.$$isolateBindings, P, E)), 
                    A) {
                        var M, n = P || S;
                        n && A[n.name] && (p = n.$$bindings.bindToController, (J = A[n.name]) && J.identifier && p && (M = J, 
                        l.$$destroyBindings = Y(c, f, J.instance, p, n)));
                        for (s in A) {
                            J = A[s];
                            var C = J();
                            C !== J.instance && (J.instance = C, ja.data("$" + s + "Controller", C), J === M && (l.$$destroyBindings(), 
                            l.$$destroyBindings = Y(c, f, C, p, n)));
                        }
                    }
                    for (s = 0, l = h.length; l > s; s++) p = h[s], $(p, p.isolateScope ? E : c, ja, f, p.require && t(p.directiveName, p.require, ja, A), ha);
                    var ya = c;
                    for (P && (P.template || null === P.templateUrl) && (ya = E), a && a(ya, e.childNodes, u, g), 
                    s = k.length - 1; s >= 0; s--) p = k[s], $(p, p.isolateScope ? E : c, ja, f, p.require && t(p.directiveName, p.require, ja, A), ha);
                }
                m = m || {};
                for (var C, x, v, za, J = -Number.MAX_VALUE, S = m.newScopeDirective, w = m.controllerDirectives, P = m.newIsolateScopeDirective, F = m.templateDirective, A = m.nonTlbTranscludeDirective, n = !1, M = !1, r = m.hasElementTranscludeDirective, ba = d.$$element = z(b), y = e, wa = 0, G = a.length; G > wa; wa++) {
                    C = a[wa];
                    var Bb = C.$$start, I = C.$$end;
                    if (Bb && (ba = ya(b, Bb, I)), v = u, J > C.priority) break;
                    if ((v = C.scope) && (C.templateUrl || (D(v) ? (N("new/isolated scope", P || S, C, ba), 
                    P = C) : N("new/isolated scope", P, C, ba)), S = S || C), x = C.name, !C.templateUrl && C.controller && (v = C.controller, 
                    w = w || ga(), N("'" + x + "' controller", w[x], C, ba), w[x] = C), (v = C.transclude) && (n = !0, 
                    C.$$tlb || (N("transclusion", A, C, ba), A = C), "element" == v ? (r = !0, J = C.priority, 
                    v = ba, ba = d.$$element = z(W.createComment(" " + x + ": " + d[x] + " ")), b = ba[0], 
                    U(f, xa.call(v, 0), b), y = V(v, e, J, g && g.name, {
                        nonTlbTranscludeDirective: A
                    })) : (v = z(Ub(b)).contents(), ba.empty(), y = V(v, e))), C.template) if (M = !0, 
                    N("template", F, C, ba), F = C, v = B(C.template) ? C.template(ba, d) : C.template, 
                    v = fa(v), C.replace) {
                        if (g = C, v = Sb.test(v) ? Yc(Xb(C.templateNamespace, T(v))) : [], b = v[0], 1 != v.length || b.nodeType !== pa) throw ea("tplrt", x, "");
                        U(f, ba, b), G = {
                            $attr: {}
                        }, v = ha(b, [], G);
                        var Q = a.splice(wa + 1, a.length - (wa + 1));
                        P && Zc(v), a = a.concat(v).concat(Q), $c(d, G), G = a.length;
                    } else ba.html(v);
                    if (C.templateUrl) M = !0, N("template", F, C, ba), F = C, C.replace && (g = C), 
                ...
                return L.scope = S && !0 === S.scope, L.transcludeOnThisElement = n, L.templateOnThisElement = M, 
                L.transclude = y, m.hasElementTranscludeDirective = r, L;
            }
            function Zc(a) {
            ...
            function x(b, d, f, g, h, k, l) {
                ...
                if (h = null, e.hasOwnProperty(d)) {
                    var m;
                    d = a.get(d + "Directive");
                    for (var p = 0, t = d.length; t > p; p++) try {
            ...
            function Lf(a, b, c, e, f, g, h, k) {
                var m, s, l = [], p = b[0], t = a.shift(), J = Nb(t, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: t
                ...
                return b.empty(), d(O).then(function(d) {
                    var L, w;
                    if (d = fa(d), t.replace) {
                        if (d = Sb.test(d) ? Yc(Xb(E, T(d))) : [], L = d[0], 1 != d.length || L.nodeType !== pa) throw ea("tplrt", t.name, O);
                        d = {
                            $attr: {}
                        }, U(e, b, L);
                        var A = ha(L, [], d);
                        D(t.scope) && Zc(A), a = A.concat(a), $c(c, d);
                    } else L = p, b.html(d);
                    for (a.unshift(J), m = C(a, L, c, f, b, t, g, h, k), n(e, function(a, c) {
                        a == L && (e[c] = b[0]);
                    }), s = S(b[0].childNodes, f); l.length; ) {
                        d = l.shift(), w = l.shift();
                        var M = l.shift(), V = l.shift(), A = b[0];
                        if (!d.$$destroyed) {
                            if (w !== p) {
                                var ya = w.className;
                                k.hasElementTranscludeDirective && t.replace || (A = Ub(L)), U(M, z(w), A), F(z(A), ya);
                            }
                            w = m.transcludeOnThisElement ? P(d, m.transclude, V) : V, m(s, d, A, e, w, m);
                        }
                    }
                    l = null;
                }), function(a, b, c, d, e) {
                    a = e, b.$$destroyed || (l ? l.push(b, c, d, a) : (m.transcludeOnThisElement && (a = P(b, m.transclude, e)), 
                    m(s, b, c, d, a, m)));
                };
            }
            function za(a, b) {
            ...
            function wa(a, c) {
                ...
                d && a.push({
                    ...
                    compile: function(a) {
                        a = a.parent();
                        var b = !!a.length;
                        return b && V.$$addBindingClass(a), function(a, c) {
                            var e = c.parent();
                            b || V.$$addBindingClass(e), V.$$addBindingInfo(e, d.expressions), a.$watch(d, function(a) {
                                c[0].nodeValue = a;
                            });
                        };
                    }
                        ...
                        compile: function() {
                            return {
                                pre: function(a, c, h) {
                                    ...
                                    var m = h[e];
                                    m !== d && (l = m && b(m, !0, g, f), d = m), l && (h[e] = l(a), (c[e] || (c[e] = [])).$$inter = !0, 
            ...
            function U(a, b, c) {
                ...
                for (f && f.replaceChild(c, d), a = W.createDocumentFragment(), a.appendChild(d), 
            ...
            function Y(a, c, d, e, f, g) {
                var h;
                return n(e, function(e, g) {
                    var m, s, p, L, k = e.attrName, l = e.optional;
                    switch (e.mode) {
                      case "@":
                        l || Na.call(c, k) || (d[g] = c[k] = void 0), c.$observe(k, function(a) {
                            H(a) && (d[g] = a);
                        }), c.$$observers[k].$$scope = a, H(c[k]) && (d[g] = b(c[k])(a));
                        break;
                      ...
                      case "=":
                        ...
                        if (l && !c[k]) break;
                        s = w(c[k]), L = s.literal ? ka : function(a, b) {
                            return a === b || a !== a && b !== b;
                        }, p = s.assign || function() {
                            throw m = d[g] = s(a), ea("nonassign", c[k], f.name);
                        }, m = d[g] = s(a), l = function(b) {
                            return L(b, d[g]) || (L(b, m) ? p(a, b = d[g]) : d[g] = b), m = b;
                        }, l.$stateful = !0, l = e.collection ? a.$watchCollection(c[k], l) : a.$watch(w(c[k], l), null, s.literal), 
                        h = h || [], h.push(l);
                        break;

                      case "&":
                        if (s = c.hasOwnProperty(k) ? w(c[k]) : v, s === v && l) break;
                        d[g] = function(b) {
                            return s(a, b);
                        };
                    }
            ...
            aa.prototype = {
                ...
                $set: function(a, b, d, e) {
                    ...
                    g = ta(this.$$element), "a" === g && "href" === a || "img" === g && "src" === a) this[a] = b = J(b, "src" === a); else if ("img" === g && "srcset" === a) {
                        for (var g = "", h = T(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(h) ? k : /(,)/, h = h.split(k), k = Math.floor(h.length / 2), l = 0; k > l; l++) var m = 2 * l, g = g + J(T(h[m]), !0), g = g + (" " + T(h[m + 1]));
                        h = T(h[2 * l]).split(/\s/), g += J(T(h[0]), !0), 2 === h.length && (g += " " + T(h[1])), 
                        this[a] = b = g;
                    }
            ...
            return V.$$addBindingInfo = m ? function(a, b) {
                var c = a.data("$binding") || [];
                K(b) ? c = c.concat(b) : c.push(b), a.data("$binding", c);
            } : v, V.$$addBindingClass = m ? function(a) {
                F(a, "ng-binding");
            } : v, V.$$addScopeInfo = m ? function(a, b, c, d) {
                a.data(c ? d ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope", b);
            } : v, V.$$addScopeClass = m ? function(a, b) {
    ...
    function Xe() {
        ...
        this.register = function(a, d) {
            Ta(a, "controller"), D(a) ? Q(b, a) : b[a] = d;
            ...
            return function(f, g, h, l) {
                var k, m, q;
                if (h = !0 === h, l && H(l) && (q = l), H(f)) {
                    if (l = f.match(Vc), !l) throw Nf("ctrlfmt", f);
                    m = l[1], q = q || l[3], f = b.hasOwnProperty(m) ? b[m] : Bc(g.$scope, m, !0) || (a ? Bc(d, m, !0) : u), 
                    Sa(f, m, !0);
                }
                return h ? (h = (K(f) ? f[f.length - 1] : f).prototype, k = Object.create(h || null), 
                q && e(g, q, k, m || f.name), Q(function() {
                    var a = c.invoke(f, k, g, m);
                    return a !== k && (D(a) || B(a)) && (k = a, q && e(g, q, k, m || f.name)), k;
                }, {
                    instance: k,
                    identifier: q
                })) : (k = c.instantiate(f, g, m), q && e(g, q, k, m || f.name), k);
            };
        } ];
    }
    function Ye() {
    ...
    function Zb(b, a) {
        if (H(b)) {
            ...
            if (c) {
                ...
                (d = d && 0 === d.indexOf(bd)) || (d = (d = c.match(Pf)) && Qf[d[0]].test(c)), d && (b = uc(c));
            }
        }
        return b;
    }
    ...
    function dd(b) {
        var a;
        return function(c) {
            return a || (a = cd(b)), c ? (c = a[I(c)], void 0 === c && (c = null), c) : a;
        };
    }
    function ed(b, a, c, d) {
        return B(d) ? d(b, a, c) : (n(d, function(d) {
            b = d(b, a, c);
        }), b);
    }
    function cf() {
        ...
        this.$get = [ "$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(e, f, g, h, l, k) {
            function m(a) {
                function d(a) {
                    var b = Q({}, a);
                    return b.data = a.data ? ed(a.data, a.headers, a.status, f.transformResponse) : a.data, 
                ...
                f.headers = function(a) {
                    var f, g, h, c = b.headers, d = Q({}, a.headers), c = Q({}, c.common, c[I(a.method)]);
                    a: for (f in c) {
                        g = I(f);
                    ...
                    return e(d, ia(a));
                }(a), f.method = rb(f.method), f.paramSerializer = H(f.paramSerializer) ? k.get(f.paramSerializer) : f.paramSerializer;
                var g = [ function(a) {
                    var c = a.headers, e = ed(a.data, dd(c), u, a.transformRequest);
                    return y(e) && n(c, function(a, b) {
                ...
                }) : (h.success = fd("success"), h.error = fd("error")), h;
            }
            function q(c, d) {
                function g(b, c, d, e) {
                    function f() {
                    ...
                    F && (b >= 200 && 300 > b ? F.put(P, [ b, c, cd(d), e ]) : F.remove(P)), a ? h.$applyAsync(f) : (f(), 
                    h.$$phase || h.$apply());
                }
                function k(a, b, d, e) {
                    b = Math.max(b, 0), (b >= 200 && 300 > b ? O.resolve : O.reject)({
                        data: a,
                        status: b,
                        headers: dd(d),
                        config: c,
                ...
                var F, n, O = l.defer(), J = O.promise, S = c.headers, P = s(c.url, c.paramSerializer(c.params));
                return m.pendingRequests.push(c), J.then(E, E), !c.cache && !b.cache || !1 === c.cache || "GET" !== c.method && "JSONP" !== c.method || (F = D(c.cache) ? c.cache : D(b.cache) ? b.cache : t), 
                ...
                e(c.method, P, d, g, S, c.timeout, c.withCredentials, c.responseType)), J;
            }
            function s(a, b) {
    ...
    function Sf(b, a, c, d, e) {
        ...
        return function(e, h, l, k, m, q, s, t) {
            ...
            function L(a, d, e, f, g) {
                M !== u && c.cancel(M), p = A = null, a(d, e, f, g), b.$$completeOutstandingRequest(v);
            }
            if (b.$$incOutstandingRequestCount(), h = h || b.url(), "jsonp" == I(e)) {
                var w = "_" + (d.counter++).toString(36);
                d[w] = function(a) {
                    d[w].data = a, d[w].called = !0;
                };
                var p = f(h.replace("JSON_CALLBACK", "angular.callbacks." + w), w, function(a, b) {
                    L(k, a, d[w].data, "", b), d[w] = v;
                });
            } else {
                var A = a();
                if (A.open(e, h, !0), n(m, function(a, b) {
                    x(a) && A.setRequestHeader(b, a);
                }), A.onload = function() {
                    var a = A.statusText || "", b = "response" in A ? A.response : A.responseText, c = 1223 === A.status ? 204 : A.status;
                    0 === c && (c = b ? 200 : "file" == Aa(h).protocol ? 404 : 0), L(k, c, b, A.getAllResponseHeaders(), a);
                }, e = function() {
                    L(k, -1, null, null, "");
                }, A.onerror = e, A.onabort = e, s && (A.withCredentials = !0), t) try {
                    A.responseType = t;
                } catch (r) {
                    if ("json" !== t) throw r;
                }
            ...
            if (q > 0) var M = c(E, q); else q && B(q.then) && q.then(E);
        };
    }
    function af() {
        var b = "{{", a = "}}";
        this.startSymbol = function(a) {
            ...
            function h(f, h, m, q) {
                ...
                q = !!q;
                for (var p, n, r = 0, M = [], O = [], J = f.length, F = [], V = []; J > r; ) {
                    if (-1 == (p = f.indexOf(b, r)) || -1 == (n = f.indexOf(a, p + l))) {
                        r !== J && F.push(g(f.substring(r)));
                        break;
                    }
                    r !== p && F.push(g(f.substring(r, p))), r = f.substring(p + l, n), M.push(r), O.push(c(r, w)), 
                    r = n + k, V.push(F.length), F.push("");
                }
                if (m && 1 < F.length && Ka.throwNoconcat(f), !h || M.length) {
                    var S = function(a) {
    ...
    function bf() {
        this.$get = [ "$rootScope", "$window", "$q", "$$q", function(b, a, c, d) {
            function e(e, h, l, k) {
                ...
                return l = x(l) ? l : 0, p.then(null, null, m ? function() {
                    e.apply(null, q);
                } : e), p.$$intervalId = s(function() {
                    w.notify(E++), l > 0 && E >= l && (w.resolve(E), t(p.$$intervalId), delete f[p.$$intervalId]), 
                    L || b.$apply();
                }, h), f[p.$$intervalId] = w, p;
            }
            var f = {};
    ...
    function id(b, a) {
        ...
        a.$$search = xc(d.search), a.$$hash = decodeURIComponent(d.hash), a.$$path && "/" != a.$$path.charAt(0) && (a.$$path = "/" + a.$$path);
    }
    function ra(b, a) {
    ...
    function bc(b, a, c) {
        this.$$html5 = !0, c = c || "", hd(b, this), this.$$parse = function(b) {
            var c = ra(a, b);
            if (!H(c)) throw Db("ipthprfx", b, a);
            id(c, this), this.$$path || (this.$$path = "/"), this.$$compose();
            ...
            var f, g;
            return (f = ra(b, d)) !== u ? (g = f, g = (f = ra(c, f)) !== u ? a + (ra("/", f) || f) : b + g) : (f = ra(a, d)) !== u ? g = a + f : a == d + "/" && (g = a), 
            g && this.$$parse(g), !!g;
        };
    }
    function cc(b, a, c) {
        hd(b, this), this.$$parse = function(d) {
            var f, e = ra(b, d) || ra(a, d);
            y(e) || "#" !== e.charAt(0) ? this.$$html5 ? f = e : (f = "", y(e) && (b = d, this.replace())) : (f = ra(c, e), 
            y(f) && (f = e)), id(f, this), d = this.$$path;
            var e = b, g = /^\/[A-Z]:(\/.*)/;
    ...
    function jd(b, a, c) {
        this.$$html5 = !0, cc.apply(this, arguments), this.$$parseLinkUrl = function(d, e) {
            if (e && "#" === e[0]) return this.hash(e.slice(1)), !0;
            var f, g;
            return b == Ja(d) ? f = d : (g = ra(a, d)) ? f = b + c + g : a === d + "/" && (f = a), 
            f && this.$$parse(f), !!f;
        }, this.$$compose = function() {
            var a = Pb(this.$$search), e = this.$$hash ? "#" + nb(this.$$hash) : "";
    ...
    function kd(b, a) {
        return function(c) {
            return y(c) ? this[b] : (this[b] = a(c), this.$$compose(), this);
        };
    }
    function gf() {
        var b = "", a = {
        ...
        this.hashPrefix = function(a) {
            ...
            if (a.enabled) {
                ...
                s = q.substring(0, q.indexOf("/", q.indexOf("//") + 2)) + (m || "/"), m = e.history ? bc : jd;
            } else s = Ja(q), m = cc;
            var t = s.substr(0, Ja(s).lastIndexOf("/") + 1);
            k = new m(s, t, "#" + b), k.$$parseLinkUrl(q, q), k.$$state = d.state();
        ...
        this.$get = [ "$filter", function(c) {
            ...
            function e(a, b, c, e, f) {
                ...
                if (1 === g.length) {
                    ...
                    return a.$watch(function(a) {
                        var b = g(a);
                        return d(b, k) || (h = e(a, u, u, [ b ]), k = b && dc(b)), h;
                    }, b, c, f);
                }
                for (var l = [], m = [], q = 0, n = g.length; n > q; q++) l[q] = d, m[q] = null;
                return a.$watch(function(a) {
                    for (var b = !1, c = 0, f = g.length; f > c; c++) {
                        var k = g[c](a);
                        (b || (b = !d(k, l[c]))) && (m[c] = k, l[c] = k && dc(k));
                    }
            ...
            function f(a, b, c, d) {
                ...
                return e = a.$watch(function(a) {
                    ...
                    f = a, B(b) && b.apply(this, arguments), x(a) && d.$$postDigest(function() {
                        x(f) && e();
                    });
                }, c);
            }
            ...
            return function(d, k, E) {
                ...
                switch (typeof d) {
                  case "string":
                    p = d = d.trim();
                    var r = E ? a : b;
                    return n = r[p], n || (":" === d.charAt(0) && ":" === d.charAt(1) && (w = !0, d = d.substring(2)), 
                    E = E ? q : m, n = new ec(E), n = new fc(n, c, E).parse(d), n.constant ? n.$$watchDelegate = h : w ? n.$$watchDelegate = n.literal ? g : f : n.inputs && (n.$$watchDelegate = e), 
                    r[p] = n), l(n, k);
    ...
    function td(b, a) {
        ...
        Q(d.prototype, {
            ...
            $$resolve: function(b) {
                ...
                try {
                    (D(b) || B(b)) && (d = b && b.then), B(d) ? (this.promise.$$state.status = -1, d.call(b, e[0], e[1], this.notify)) : (this.promise.$$state.value = b, 
        ...
        }, q.when = m, q.resolve = m, q.all = function(a) {
    ...
    function kf() {
        function b(a) {
            function b() {
                ...
                this.$$listeners = {}, this.$$listenerCount = {}, this.$$watchersCount = 0, this.$id = ++mb, 
        ...
        this.digestTtl = function(b) {
            ...
            function m() {
                this.$id = ++mb, this.$$phase = this.$parent = this.$$watchers = this.$$nextSibling = this.$$prevSibling = this.$$childHead = this.$$childTail = null, 
            ...
            m.prototype = {
                ...
                $watch: function(a, b, c, e) {
                    ...
                    return d = null, B(b) || (l.fn = v), k || (k = g.$$watchers = []), k.unshift(l), 
                    s(this, 1), function() {
                ...
                $watchCollection: function(a, b) {
                    function c(a) {
                        ...
                        var b, d, g, h;
                        if (!y(e)) {
                            if (D(e)) if (Da(e)) for (f !== q && (f = q, t = f.length = 0, l++), a = e.length, 
                    ...
                    c.$stateful = !0;
                    var e, f, g, d = this, k = 1 < b.length, l = 0, m = h(a, c), q = [], s = {}, p = !0, t = 0;
                    return this.$watch(m, function() {
                        if (p ? (p = !1, b(e, e, d)) : b(e, g, d), k) if (D(e)) if (Da(e)) {
                            g = Array(e.length);
                ...
                $digest: function() {
                    var b, f, h, k, m, s, n, C, M, t = a, w = [];
                    q("$digest"), l.$$checkUrlChange(), this === p && null !== e && (l.defer.cancel(e), 
                    L()), d = null;
                    do {
                        for (s = !1, n = this; u.length; ) {
                            try {
                        ...
                        a: do {
                            if (k = n.$$watchers) for (m = k.length; m--; ) try {
                                if (b = k[m]) if ((f = b.get(n)) === (h = b.last) || (b.eq ? ka(f, h) : "number" == typeof f && "number" == typeof h && isNaN(f) && isNaN(h))) {
                                    if (b === d) {
                                        s = !1;
                                        break a;
                                    }
                                } else s = !0, d = b, b.last = b.eq ? fa(f, null) : f, b.fn(f, h === r ? f : h, n), 
            ...
            return h[oa.HTML] = e(g), h[oa.CSS] = e(g), h[oa.URL] = e(g), h[oa.JS] = e(g), h[oa.RESOURCE_URL] = e(h[oa.URL]), 
            {
                ...
                getTrusted: function(c, e) {
                    ...
                    if (c === oa.RESOURCE_URL) {
                        var q, s, g = Aa(e.toString()), t = !1;
                        for (q = 0, s = b.length; s > q; q++) if (d(b[q], g)) {
                            t = !0;
                            break;
                        }
                        if (t) for (q = 0, s = a.length; s > q; q++) if (d(a[q], g)) {
                            t = !1;
                            break;
                        }
                        if (t) return e;
    ...
    function nf() {
        ...
        this.enabled = function(a) {
            ...
            d.isEnabled = function() {
                ...
                return b;
            }, d.valueOf = Za), d.parseAs = function(b, c) {
                var e = a(c);
    ...
    function pf() {
        this.$get = [ "$window", "$document", function(b, a) {
            var g, c = {}, d = Y((/android (\d+)/.exec(I((b.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((b.navigator || {}).userAgent), f = a[0] || {}, h = /^(Moz|webkit|ms)(?=[A-Z])/, l = f.body && f.body.style, k = !1, m = !1;
            if (l) {
                ...
                m = !!("animation" in l || g + "Animation" in l), !d || k && m || (k = H(l.webkitTransition), 
    ...
    function rf() {
        this.$get = [ "$templateCache", "$http", "$q", "$sce", function(b, a, c, d) {
            function e(f, g) {
                e.totalPendingRequests++, H(f) && b.get(f) || (f = d.getTrustedResourceUrl(f));
                var h = a.defaults && a.defaults.transformResponse;
                return K(h) ? h = h.filter(function(a) {
                    return a !== Zb;
                }) : h === Zb && (h = null), a.get(f, {
                    cache: b,
                    transformResponse: h
    ...
    function tf() {
        this.$get = [ "$rootScope", "$browser", "$q", "$$q", "$exceptionHandler", function(b, a, c, d, e) {
            function f(f, l, k) {
                B(f) || (k = l, l = f, f = v);
                var n, m = xa.call(arguments, 3), q = x(k) && !k, s = (q ? d : c).defer(), t = s.promise;
                return n = a.defer(function() {
                    try {
    ...
    function Aa(b) {
        return Va && (Z.setAttribute("href", b), b = Z.href), Z.setAttribute("href", b), 
        {
            href: Z.href,
    ...
    function gd(b) {
        return b = H(b) ? Aa(b) : b, b.protocol === wd.protocol && b.host === wd.host;
    }
    function uf() {
        this.$get = qa(N);
    }
    function xd(b) {
        ...
        return function() {
            ...
            l = g.indexOf("="), l > 0 && (k = a(g.substring(0, l)), d[k] === u && (d[k] = a(g.substring(l + 1))));
            return d;
        };
    }
    function yf() {
    ...
    function eg(b, a, c) {
        var d = D(b) && "$" in b;
        return !0 === a ? a = ka : B(a) || (a = function(a, b) {
            return y(a) ? !1 : null === a || null === b ? a === b : D(b) || D(a) && !pc(a) ? !1 : (a = I("" + a), 
            b = I("" + b), -1 !== a.indexOf(b));
        }), function(e) {
    ...
    function yd(b) {
        ...
        return function(b, d, e) {
            return y(d) && (d = a.CURRENCY_SYM), y(e) && (e = a.PATTERNS[1].maxFrac), null == b ? b : Cd(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, e).replace(/\u00A4/g, d);
        };
    }
    function Ad(b) {
        var a = b.NUMBER_FORMATS;
    ...
    function Cd(b, a, c, d, e) {
        ...
        if (g || k) e > 0 && 1 > b && (l = b.toFixed(e), b = parseFloat(l)); else {
            g = (h.split(Dd)[1] || "").length, y(e) && (e = Math.min(Math.max(a.minFrac, g), a.maxFrac)), 
            b = +(Math.round(+(b.toString() + "e" + e)).toString() + "e" + -e);
            var g = ("" + b).split(Dd), h = g[0], g = g[1] || "", q = 0, s = a.lgSize, t = a.gSize;
            if (h.length >= s + t) for (q = h.length - s, k = 0; q > k; k++) 0 === (q - k) % t && 0 !== k && (l += c), 
            l += h.charAt(k);
        ...
        return 0 === b && (f = !1), m.push(f ? a.negPre : a.posPre, l, f ? a.negSuf : a.posSuf), 
        m.join("");
    }
    function Gb(b, a, c) {
        var d = "";
    ...
    function zd(b) {
        function a(a) {
            ...
            if (b = a.match(c)) {
                ...
                b[9] && (f = Y(b[9] + b[10]), g = Y(b[9] + b[11])), h.call(a, Y(b[1]), Y(b[2]) - 1, Y(b[3])), 
                f = Y(b[4] || 0) - f, g = Y(b[5] || 0) - g, h = Y(b[6] || 0), b = Math.round(1e3 * parseFloat("0." + (b[7] || 0))), 
                l.call(a, f, g, h, b);
            }
            return a;
        }
        ...
        return function(c, e, f) {
            var l, k, g = "", h = [];
            if (e = e || "mediumDate", e = b.DATETIME_FORMATS[e] || e, H(c) && (c = fg.test(c) ? Y(c) : a(c)), 
            X(c) && (c = new Date(c)), !ca(c) || !isFinite(c.getTime())) return c;
            for (;e; ) (k = gg.exec(e)) ? (h = cb(h, k, 1), e = h.pop()) : (h.push(e), e = null);
            var m = c.getTimezoneOffset();
            return f && (m = vc(f, c.getTimezoneOffset()), c = Ob(c, f, !0)), n(h, function(a) {
                l = hg[a], g += l ? l(c, b.DATETIME_FORMATS, m) : a.replace(/(^'|'$)/g, "").replace(/''/g, "'");
            }), g;
        };
    }
    function ag() {
        return function(b, a) {
            return y(a) && (a = 2), db(b, a);
        };
    }
    function bg() {
        return function(b, a, c) {
            return a = 1 / 0 === Math.abs(Number(a)) ? Number(a) : Y(a), isNaN(a) ? b : (X(b) && (b = b.toString()), 
            K(b) || H(b) ? (c = !c || isNaN(c) ? 0 : Y(c), c = 0 > c && c >= -b.length ? b.length + c : c, 
    ...
    function Bd(b) {
        function a(a, c) {
            return c = c ? -1 : 1, a.map(function(a) {
                var d = 1, h = Za;
                if (B(a)) h = a; else if (H(a) && (("+" == a.charAt(0) || "-" == a.charAt(0)) && (d = "-" == a.charAt(0) ? -1 : 1, 
    ...
    function Gd(b, a, c, d, e) {
        ...
        h.$addControl(f), f.$rollbackViewValue = function() {
            ...
            Ta(a.$name, "input"), g.push(a), a.$name && (f[a.$name] = a);
            ...
            d.removeClass(b, Xa), d.addClass(b, Jb), f.$dirty = !0, f.$pristine = !1, h.$setDirty();
        }, f.$setPristine = function() {
            d.setClass(b, Xa, Jb + " ng-submitted"), f.$dirty = !1, f.$pristine = !0, f.$submitted = !1, 
            n(g, function(a) {
                a.$setPristine();
            });
    ...
    function jb(b, a, c, d) {
        return function(e, f, g, h, l, k, m) {
            ...
            Id(e, f, g, h), ib(e, f, g, h, l, k);
            var n, t = h && h.$options && h.$options.timezone;
            if (h.$$parserName = b, h.$parsers.push(function(b) {
                ...
                return q(a) ? ((n = a) && t && (n = Ob(n, t, !0)), m("date")(a, d, t)) : (n = null, 
                "");
            }), x(g.min) || g.ngMin) {
                var r;
    ...
    function Jd(b, a, c, d, e) {
        if (x(d)) {
            if (b = b(d), !b.constant) throw kb("constexpr", c, d);
            return b(a);
        }
        return e;
    }
                        ...
                        if (!0 === a || f.$index % 2 === a) {
                            ...
                            if (m) {
                                if (!ka(b, m)) {
                                    ...
                                    n && n.length && c.addClass(g, n), k && k.length && c.removeClass(g, k);
                                }
                            } else {
                                var n = l(k, 1);
                                h.$addClass(n);
    ...
    function Hd(b) {
        ...
        function c(b, c) {
            b = b ? "-" + zc(b, "-") : "", a(lb + b, !0 === c), a(Kd + b, !1 === c);
        }
        var d = b.ctrl, e = b.$element, f = {}, g = b.set, h = b.unset, l = b.parentForm, k = b.$animate;
        f[Kd] = !(f[lb] = e.hasClass(lb)), d.$setValidity = function(b, e, f) {
            e === u ? (d.$pending || (d.$pending = {}), g(d.$pending, b, f)) : (d.$pending && h(d.$pending, b, f), 
            Ld(d.$pending) && (d.$pending = u)), ab(e) ? e ? (h(d.$error, b, f), g(d.$$success, b, f)) : (g(d.$error, b, f), 
            h(d.$$success, b, f)) : (h(d.$error, b, f), h(d.$$success, b, f)), d.$pending ? (a(Md, !0), 
            d.$valid = d.$invalid = u, c("", null)) : (a(Md, !1), d.$valid = Ld(d.$error), d.$invalid = !d.$valid, 
    ...
    var Va, z, la, Rb, jg = /^\/(.+)\/([a-z]*)$/, I = function(b) {
        return H(b) ? b.toLowerCase() : b;
    }, Na = Object.prototype.hasOwnProperty, rb = function(b) {
        return H(b) ? b.toUpperCase() : b;
    }, xa = [].slice, Mf = [].splice, kg = [].push, sa = Object.prototype.toString, qc = Object.getPrototypeOf, Ea = G("ng"), aa = N.angular || (N.angular = {}), mb = 0;
    Va = W.documentMode, v.$inject = [], Za.$inject = [];
    var Qb, K = Array.isArray, sc = /^\[object (Uint8(Clamped)?)|(Uint16)|(Uint32)|(Int8)|(Int16)|(Int32)|(Float(32)|(64))Array\]$/, T = function(b) {
        return H(b) ? b.trim() : b;
    }, ud = function(b) {
        ...
        for (a = 0; c > a; ++a) if (d = Qa[a], b = W.querySelector("[" + d.replace(":", "\\:") + "jq]")) {
            e = b.getAttribute(d + "jq");
            break;
        }
        return ob.name_ = e;
    }, Qa = [ "ng-", "data-ng-", "ng:", "x-ng-" ], be = /[A-Z]/g, Ac = !1, pa = 1, Pa = 3, fe = {
        full: "1.4.5",
        major: 1,
        minor: 4,
        dot: 5,
    ...
    }, Tb = G("jqLite"), Df = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Sb = /<|&#?\w+;/, Bf = /<([\w:]+)/, Cf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, na = {
    ...
    n({
        ...
        hasClass: wb,
        css: function(b, a, c) {
            return a = fb(a), x(c) ? void (b.style[a] = c) : b.style[a];
        },
        attr: function(b, a, c) {
            var d = b.nodeType;
            if (d !== Pa && 2 !== d && 8 !== d) if (d = I(a), Ab[d]) {
                if (!x(c)) return b[a] || (b.attributes.getNamedItem(a) || v).specified ? d : u;
                c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d));
            } else if (x(c)) b.setAttribute(a, c); else if (b.getAttribute) return b = b.getAttribute(a, 2), 
            null === b ? u : b;
        },
        prop: function(b, a, c) {
            return x(c) ? void (b[a] = c) : b[a];
        },
        text: function() {
            function b(a, b) {
                if (y(b)) {
        ...
        html: function(b, a) {
            return y(a) ? b.innerHTML : (tb(b, !0), void (b.innerHTML = a));
        },
        empty: Pc
    }, function(b, a) {
        R.prototype[a] = function(a, d) {
            ...
            if (b !== Pc && (2 == b.length && b !== wb && b !== Oc ? a : d) === u) {
                if (D(a)) {
                    for (e = 0; g > e; e++) if (b === Vb) b(this[e], a); else for (f in a) b(this[e], f, a[f]);
                    return this;
                }
        ...
        R.prototype[c] = function(c, e, f) {
            for (var g, h = 0, l = this.length; l > h; h++) y(g) ? (g = a(this[h], c, e, f), 
    ...
    } ], Uc = /^[^\(]*\(\s*([^\)]*)\)/m, mg = /,/, ng = /^\s*(_?)(\S+?)\1\s*$/, Tc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Ha = G("$injector");
        ...
        if ("function" == typeof a) {
            if (!(e = a.$inject)) {
                if (e = [], a.length) {
                    ...
                    c = a.toString().replace(Tc, ""), c = c.match(Uc), n(c[1].split(mg), function(a) {
    ...
    var Nd = G("$animate"), Ue = function() {
        ...
        this.$get = [ "$$AnimateRunner", "$rootScope", function(d, e) {
            function f(d, f, l) {
                var k = a.get(d);
                k || (a.put(d, k = {}), c.push(d)), d = function(a, c) {
                    var d = !1;
                    return a && (a = H(a) ? a.split(" ") : K(a) ? a : [], n(a, function(a) {
                        a && (d = !0, k[a] = c);
                    })), d;
                }, f = d(f, !0), l = d(l, !1), !f && !l || 1 < c.length || e.$$postDigest(function() {
                    n(c, function(c) {
                        var d = a.get(c);
                        if (d) {
        ...
        this.$$registeredAnimations = Object.create(null), this.register = function(d, e) {
            ...
            return {
                ...
                enter: function(f, g, h, l) {
                    return g = g && z(g), h = h && z(h), g = g || h.parent(), c(f, g, h), a.push(f, "enter", Ia(l));
                },
                move: function(f, g, h, l) {
                    return g = g && z(g), h = h && z(h), g = g || h.parent(), c(f, g, h), a.push(f, "move", Ia(l));
                },
                leave: function(c, e) {
                ...
                addClass: function(c, e, h) {
                    return h = Ia(h), h.addClass = hb(h.addclass, e), a.push(c, "addClass", h);
                },
                removeClass: function(c, e, h) {
                    return h = Ia(h), h.removeClass = hb(h.removeClass, e), a.push(c, "removeClass", h);
                },
                setClass: function(c, e, h, l) {
                    return l = Ia(l), l.addClass = hb(l.addClass, e), l.removeClass = hb(l.removeClass, h), 
                    a.push(c, "setClass", l);
                },
                animate: function(c, e, h, l, k) {
                    return k = Ia(k), k.from = k.from ? Q(k.from, e) : e, k.to = k.to ? Q(k.to, h) : h, 
                    k.tempClasses = hb(k.tempClasses, l || "ng-inline-animate"), a.push(c, "animate", k);
                }
            };
        } ];
    } ], Se = function() {
            ...
            return d.prototype = {
                ...
                function g() {
                    return a(function() {
                        ...
                        f.removeClass = null), f.to && (c.css(f.to), f.to = null), h || l.done(), h = !0;
                    }), l;
                }
    ...
    var Xc = /^((?:x|data)[\:\-_])/i, Nf = G("$controller"), Vc = /^(\S+)(\s+as\s+(\w+))?$/, $e = function() {
        this.$get = [ "$document", function(a) {
            return function(c) {
                return c ? !c.nodeType && c instanceof z && (c = c[0]) : c = a[0].body, c.offsetWidth + 1;
            };
        } ];
    ...
    var pg = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, Tf = {
        ...
        search: function(a, c) {
            switch (arguments.length) {
              ...
              case 1:
                if (H(a) || X(a)) a = a.toString(), this.$$search = xc(a); else {
                    if (!D(a)) throw Db("isrcharg");
    ...
    n([ jd, cc, bc ], function(a) {
        a.prototype = Object.create(qg), a.prototype.state = function(c) {
            ...
            return this.$$state = y(c) ? null : c, this;
        };
    });
    ...
    ec.prototype = {
        ...
        throwError: function(a, c, d) {
            throw d = d || this.index, c = x(c) ? "s " + c + "-" + this.index + " [" + this.text.substring(c, d) + "]" : " " + d, 
    ...
    r.Program = "Program", r.ExpressionStatement = "ExpressionStatement", r.AssignmentExpression = "AssignmentExpression", 
    r.ConditionalExpression = "ConditionalExpression", r.LogicalExpression = "LogicalExpression", 
    r.BinaryExpression = "BinaryExpression", r.UnaryExpression = "UnaryExpression", 
    r.CallExpression = "CallExpression", r.MemberExpression = "MemberExpression", r.Identifier = "Identifier", 
    r.Literal = "Literal", r.ArrayExpression = "ArrayExpression", r.Property = "Property", 
    r.ObjectExpression = "ObjectExpression", r.ThisExpression = "ThisExpression", r.NGValueParameter = "NGValueParameter", 
    r.prototype = {
        ast: function(a) {
        ...
        compile: function(a, c) {
            ...
            g = nd(e.body), d.stage = "inputs", n(g, function(a, c) {
                var e = "fn" + c;
                d.state[e] = {
                    vars: [],
                    body: [],
            ...
            this.state = this.stage = u, f.literal = qd(e), f.constant = e.constant, f;
        },
        USE: "use",
        STRICT: "strict",
        watchFns: function() {
            var a = [], c = this.state.inputs, d = this;
            return n(c, function(c) {
        ...
        filterPrefix: function() {
            var a = [], c = this;
            return n(this.state.filters, function(d, e) {
        ...
        recurse: function(a, c, d, e, f, g) {
            var h, l, m, q, k = this;
            if (e = e || v, !g && x(a.watchId)) c = c || this.nextId(), this.if_("i", this.lazyAssign(c, this.computedMember("i", a.watchId)), this.lazyRecurse(a, c, d, e, f, !0)); else switch (a.type) {
              case r.Program:
              ...
              case r.Literal:
                q = this.escape(a.value), this.assign(c, q), e(q);
                break;

              case r.UnaryExpression:
                this.recurse(a.argument, u, u, function(a) {
                    l = a;
                }), q = a.operator + "(" + this.ifDefined(l, 0) + ")", this.assign(c, q), e(q);
                break;
              ...
              case r.Identifier:
                ...
                d.computed = !1, d.name = a.name), Wa(a.name), k.if_("inputs" === k.stage || k.not(k.getHasOwnProperty("l", a.name)), function() {
              ...
              case r.MemberExpression:
                h = d && (d.context = this.nextId()) || this.nextId(), c = c || this.nextId(), k.recurse(a.object, h, u, function() {
                    k.if_(k.notNull(h), function() {
                        ...
                        d.name = l)) : (Wa(a.property.name), f && 1 !== f && k.if_(k.not(k.nonComputedMember(h, a.property.name)), k.lazyAssign(k.nonComputedMember(h, a.property.name), "{}")), 
                        q = k.nonComputedMember(h, a.property.name), (k.state.expensiveChecks || Fb(a.property.name)) && (q = k.ensureSafeObject(q)), 
                        k.assign(c, q), d && (d.computed = !1, d.name = a.property.name));
                    }, function() {
              ...
              case r.CallExpression:
                ...
                m = [], k.recurse(a.callee, l, h, function() {
                    k.if_(k.notNull(l), function() {
                        ...
                        q = k.ensureSafeObject(q), k.assign(c, q);
                    }, function() {
                        k.assign(c, "undefined");
                    }), e(c);
                }));
              ...
              case r.AssignmentExpression:
                ...
                this.recurse(a.left, u, h, function() {
                    k.if_(k.notNull(h.context), function() {
                        ...
                        q = k.member(h.context, h.name, h.computed) + a.operator + l, k.assign(c, q), e(c || q);
                    });
                }, 1);
                break;
            ...
            switch (a.type) {
              ...
              case r.CallExpression:
                ...
                a.filter ? function(a, d, e, g) {
                    ...
                    var t, n = f(a, d, e, q);
                    if (null != n.value) {
                        Ba(n.context, g.expression), ld(n.value, g.expression), t = [];
              ...
              case r.AssignmentExpression:
                return e = this.recurse(a.left, !0, 1), f = this.recurse(a.right), function(a, d, h, q) {
                    var n = e(a, d, h, q);
                    return a = f(a, d, h, q), Ba(n.value, g.expression), n.context[n.name] = a, c ? {
                        value: a
                    } : a;
                };
        ...
        "unary+": function(a, c) {
            return function(d, e, f, g) {
                return d = a(d, e, f, g), d = x(d) ? +d : 0, c ? {
                    value: d
                } : d;
            };
        },
        ...
        "binary-": function(a, c, d) {
            return function(e, f, g, h) {
                var l = a(e, f, g, h);
                return e = c(e, f, g, h), l = (x(l) ? l : 0) - (x(e) ? e : 0), d ? {
                    value: l
                } : l;
            };
        },
        ...
        identifier: function(a, c, d, e, f) {
            return function(g, h, l, k) {
                return g = h && a in h ? h : g, e && 1 !== e && g && !g[a] && (g[a] = {}), h = g ? g[a] : u, 
                c && Ba(h, f), d ? {
                    context: g,
                    name: a,
                    value: h
        ...
        computedMember: function(a, c, d, e, f) {
            return function(g, h, l, k) {
                var q, n, m = a(g, h, l, k);
                return null != m && (q = c(g, h, l, k), Wa(q, f), e && 1 !== e && m && !m[q] && (m[q] = {}), 
                n = m[q], Ba(n, f)), d ? {
                    context: m,
                    name: q,
                    value: n
        ...
        nonComputedMember: function(a, c, d, e, f, g) {
            return function(h, l, k, m) {
                return h = a(h, l, k, m), f && 1 !== f && h && !h[c] && (h[c] = {}), l = null != h ? h[c] : u, 
                (d || Fb(c)) && Ba(l, g), e ? {
                    context: h,
                    name: c,
                    value: l
    ...
    var fc = function(a, c, d) {
        this.lexer = a, this.$filter = c, this.options = d, this.ast = new r(this.lexer), 
    ...
    var Od = function(a) {
                    ...
                    return {
                        pre: function(a, d, f, g) {
                            ...
                            h && (r(a, g), f.$observe(h, function(c) {
                                g.$name !== c && (r(a, u), t.$$renameControl(g, c), (r = e(g.$name))(a, g));
                            })), d.on("$destroy", function() {
                                t.$removeControl(g), r(a, u), Q(g, Ib);
                            });
                        }
                    };
                }
        ...
        number: function(a, c, d, e, f, g) {
            if (Id(a, c, d, e), ib(a, c, d, e, f, g), e.$$parserName = "number", e.$parsers.push(function(a) {
                ...
                e.$validators.min = function(a) {
                    ...
                    x(a) && !X(a) && (a = parseFloat(a, 10)), h = X(a) && !isNaN(a) ? a : u, e.$validate();
                });
            }
            if (x(d.max) || d.ngMax) {
                var l;
                e.$validators.max = function(a) {
                    return e.$isEmpty(a) || y(l) || l >= a;
                }, d.$observe("max", function(a) {
                    x(a) && !X(a) && (a = parseFloat(a, 10)), l = X(a) && !isNaN(a) ? a : u, e.$validate();
                });
            }
        },
        url: function(a, c, d, e, f, g) {
            ib(a, c, d, e, f, g), ic(e), e.$$parserName = "url", e.$validators.url = function(a, c) {
                var d = a || c;
                return e.$isEmpty(d) || sg.test(d);
            };
        },
        email: function(a, c, d, e, f, g) {
            ib(a, c, d, e, f, g), ic(e), e.$$parserName = "email", e.$validators.email = function(a, c) {
                var d = a || c;
    ...
    var xe = [ "$animate", function(a) {
        return {
            ...
            link: function(c, d, e, f, g) {
                ...
                c.$watch(e.ngIf, function(c) {
                    c ? l || g(function(c, f) {
                        l = f, c[c.length++] = W.createComment(" end ngIf: " + e.ngIf + " "), h = {
                            clone: c
        ...
        return {
            ...
            compile: function(e, f) {
                ...
                return function(e, f, n, s, r) {
                    var v, w, p, u = 0, A = function() {
                        w && (w.remove(), w = null), v && (v.$destroy(), v = null), p && (d.leave(p).then(function() {
                            w = null;
                        }), w = p, p = null);
                    };
                        ...
                        g ? (a(g, !0).then(function(a) {
                            if (q === u) {
                                ...
                                s.template = a, a = r(c, function(a) {
                                    A(), d.enter(a, null, f).then(n);
                                }), v = c, p = a, v.$emit("$includeContentLoaded", g), e.$eval(h);
                            }
                        }, function() {
        ...
        return {
            ...
            link: function(a, c, d, e) {
                ...
                e.$parsers.push(function(a) {
                    if (!y(a)) {
                        var c = [];
                        return a && n(a.split(h), function(a) {
                            a && c.push(g ? T(a) : a);
                        }), c;
                    }
                }), e.$formatters.push(function(a) {
        ...
        var w, q = f(d.ngModel), s = q.assign, r = q, E = s, L = null, p = this;
        ...
        Hd({
            ...
            p.$dirty = !1, p.$pristine = !0, g.removeClass(e, Jb), g.addClass(e, Xa);
        }, this.$setDirty = function() {
            p.$dirty = !0, p.$pristine = !1, g.removeClass(e, Xa), g.addClass(e, Jb), A.$setDirty();
            ...
            h.cancel(L), p.$viewValue = p.$$lastCommittedViewValue, p.$render();
            ...
            function e() {
                var d = !0;
                return n(p.$validators, function(e, f) {
                    var h = e(a, c);
                    d = d && h, g(f, h);
                }), d ? !0 : (n(p.$asyncValidators, function(a, c) {
                    g(c, null);
                }), !1);
            }
            function f() {
            ...
            (function() {
                ...
                return w !== u ? (w || (n(p.$validators, function(a, c) {
                    g(c, null);
            ...
            var a = p.$viewValue;
            h.cancel(L), (p.$$lastCommittedViewValue !== a || "" === a && p.$$hasNativeValidators) && (p.$$lastCommittedViewValue = a, 
            p.$pristine && this.$setDirty(), this.$$parseAndValidate());
        }, this.$$parseAndValidate = function() {
            var c = p.$$lastCommittedViewValue;
            if (w = y(c) ? u : !0) for (var d = 0; d < p.$parsers.length; d++) if (c = p.$parsers[d](c), 
            y(c)) {
                w = !1;
                break;
            }
            ...
            E(a, p.$modelValue), n(p.$viewChangeListeners, function(a) {
                try {
                    a();
                } catch (d) {
                    c(d);
            ...
            if (c !== p.$modelValue && (p.$modelValue === p.$modelValue || c === c)) {
                p.$modelValue = p.$$rawModelValue = c, w = u;
        ...
        return {
            ...
            priority: 1,
            compile: function(c) {
                return c.addClass(Xa).addClass("ng-untouched").addClass(lb), {
        ...
        return {
            ...
            controller: [ "$scope", "$attrs", function(a, c) {
                var d = this;
                this.$options = fa(a.$eval(c.ngModelOptions)), this.$options.updateOn !== u ? (this.$options.updateOnDefault = !1, 
        ...
        terminal: !0,
        priority: 1e3
    }), zg = G("ngOptions"), Ag = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/, Ie = [ "$compile", "$parse", function(a, c) {
        function d(a, d, e) {
            ...
            return {
                ...
                getWatchables: c(J, function(a) {
                    var c = [];
                    a = a || [];
                    for (var d = m(a), f = d.length, g = 0; f > g; g++) {
                        var h = a === d ? g : d[g], k = B(a[h], h), h = p(a[h], k);
                        c.push(h), (n[2] || n[1]) && (h = x(e, k), c.push(h)), n[4] && (k = y(e, k), c.push(k));
                    }
                    return c;
                }),
                getOptions: function() {
                    for (var a = [], c = {}, d = J(e) || [], g = m(d), h = g.length, n = 0; h > n; n++) {
                        var q = d === g ? n : g[n], s = B(d[q], q), r = v(e, s), q = p(r, s), t = x(e, s), w = z(e, s), s = y(e, s), r = new f(q, r, t, w, s);
                        a.push(r), c[q] = r;
                    }
                    return {
                        items: a,
        ...
        return {
            ...
            link: function(c, h, l, k) {
                ...
                function q(a, c, d, e) {
                    return c && I(c.nodeName) === d ? d = c : (d = e.cloneNode(!1), c ? a.insertBefore(d, c) : a.appendChild(d)), 
                    d;
                }
                function s(a) {
                ...
                function u() {
                    ...
                    if (O && h.prepend(p), d = r(d), F.items.forEach(function(a) {
                        var g, k;
                        a.group ? (g = c[a.group], g || (g = q(h[0], d, "optgroup", f), d = g.nextSibling, 
                        g.label = a.group, g = c[a.group] = {
                            groupElement: g,
                            currentOptionElement: g.firstChild
                        }), k = q(g.groupElement, g.currentOptionElement, "option", e), m(a, k), g.currentOptionElement = k.nextSibling) : (k = q(h[0], d, "option", e), 
                ...
                if (v) {
                    var w = k[0];
                    k = l.multiple;
                    for (var p, x = 0, y = h.children(), B = y.length; B > x; x++) if ("" === y[x].value) {
                        p = y.eq(x);
                        break;
                    }
                    ...
                    k ? (v.$isEmpty = function(a) {
                        ...
                        return K(v.$viewValue) ? v.$viewValue.map(function(a) {
                        ...
                        c && !c.disabled ? h[0].value !== c.selectValue && (J.remove(), O || p.remove(), 
                        h[0].value = c.selectValue, c.element.selected = !0, c.element.setAttribute("selected", "selected")) : null === a || O ? (J.remove(), 
                        O || h.prepend(p), h.val(""), p.prop("selected", !0), p.attr("selected", !0)) : (O || p.remove(), 
                    ...
                    u(), c.$watchCollection(D.getWatchables, u);
                }
            }
        };
        ...
        return {
            link: function(g, h, l) {
                ...
                var z, m = l.count, q = l.$attr.when && h.attr(l.$attr.when), s = l.offset || 0, r = g.$eval(q) || {}, u = {}, x = c.startSymbol(), w = c.endSymbol(), p = x + m + "-" + s + w, A = aa.noop;
                n(l, function(a, c) {
                    var d = f.exec(c);
                    ...
                    f || e in r || (e = a.pluralCat(e - s)), e === z || f && X(z) && isNaN(z) || (A(), 
                    f = u[e], y(f) ? (null != c && d.debug("ngPluralize: no rule defined for '" + e + "' in " + q), 
        ...
        return {
            ...
            compile: function(f, g) {
                ...
                return t ? w = a(t) : (A = function(a, c) {
                    return Ga(c);
                }, y = function(a) {
                    return a;
                }), function(a, f, g, k, m) {
                    w && (p = function(c, d, e) {
                        return x && (B[x] = c), B[v] = d, B.$index = e, w(a, B);
                    });
                    var t = ga();
                    a.$watchCollection(q, function(g) {
                        var k, q, B, F, H, K, G, M, I, N, w = f[0], D = ga();
                        if (r && (a[r] = g), Da(g)) M = g, q = p || A; else for (N in q = p || y, M = [], 
                        g) g.hasOwnProperty(N) && "$" !== N.charAt(0) && M.push(N);
                        for (F = M.length, N = Array(F), k = 0; F > k; k++) if (H = g === M ? k : M[k], 
                        K = g[H], G = q(H, K, k), t[G]) I = t[G], delete t[G], D[G] = I, N[k] = I; else {
                        ...
                        for (B in t) {
                            if (I = t[B], G = qb(I.clone), c.leave(G), G[0].parentNode) for (k = 0, q = G.length; q > k; k++) G[k].$$NG_REMOVED = !0;
                            I.scope.$destroy();
                        }
                        for (k = 0; F > k; k++) if (H = g === M ? k : M[k], K = g[H], I = N[k], I.scope) {
                            B = w;
                            do B = B.nextSibling; while (B && B.$$NG_REMOVED);
                            I.clone[0] != B && c.move(qb(I.clone), null, z(w)), w = I.clone[I.clone.length - 1], 
                            e(I.scope, k, v, K, x, H, F);
                        } else m(function(a, d) {
                            I.scope = d;
                            var f = l.cloneNode(!1);
                            a[a.length++] = f, c.enter(a, null, z(w)), w = f, I.clone = a, D[I.id] = I, e(I.scope, k, v, K, x, H, F);
                        });
                        t = D;
                    });
                };
                ...
                c.$watch(e.ngSwitch || e.on, function(c) {
                    ...
                    h.length = 0, k.length = 0, (g = f.cases["!" + c] || f.cases["?"]) && n(g, function(c) {
                        c.transclude(function(d, e) {
                            k.push(e);
                            var f = c.element;
                            d[d.length++] = W.createComment(" end ngSwitchWhen: "), h.push({
                                clone: d
        ...
        var e = this, f = new Ua();
        e.ngModelCtrl = Bg, e.unknownOption = z(W.createElement("option")), e.renderUnknownOption = function(c) {
                ...
                if (f) {
                    ...
                    if (g.ngModelCtrl = f, f.$render = function() {
                        ...
                        g.readValue = function() {
                            var a = [];
                            return n(c.find("option"), function(c) {
            ...
            link: function(a, c, d, e) {
                if (e) {
                    ...
                    d.$observe("pattern", function(a) {
                        if (H(a) && 0 < a.length && (a = new RegExp("^" + a + "$")), a && !a.test) throw G("ngPattern")("noregexp", g, a, ua(c));
                        f = a || u, e.$validate();
    ...
    ee(aa), aa.module("ngLocale", [], [ "$provide", function(a) {
        ...
        a.value("$locale", {
            ...
            pluralCat: function(a, e) {
                var f = 0 | a, g = e;
                return u === g && (g = Math.min(c(a), 3)), Math.pow(10, g), 1 == f && 0 == g ? "one" : "other";
            }
        });
    } ]), z(W).ready(function() {
        Zd(W, yc);
